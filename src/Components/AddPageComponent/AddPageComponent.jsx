...
const AddPageComponent = () => {
    ...
    const [newsInfo, setnewsInfo] = useState({
      ...
      const formSubmitHandler = async (event) => {
        ...
        await axios.post(`${Basic_Url}/toUpload/image`, formData)
          .then(response => {
...
//formData is used to send data in form of multipart/form-data which is required on sending text and files as request. 
//if formData not used we have to use application/json.